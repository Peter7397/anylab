...
from ..views.rag_views import get_file_processing_status, retry_file_processing, delete_uploaded_file
...
urlpatterns = [
    ...
    path('files/<int:file_id>/delete/', delete_uploaded_file, name='documents_file_delete'),
